...
(1, 'ไม่ตกไม่แตก', 0, 100, 'F', '01,11,12', 10.3, 21, NULL),
...
(9, 'ฮั่วเซ่งฮง', 500, 1000, 'F', '01,03,11,12', 10, 22, NULL),
(10, 'ธนัญธรก๋วยเตี๋ยวไก่มะระ', 0, 100, 'R', '01,11', 18.3, 1, NULL),
(11, 'Koh Lanta Pizzeria', 101, 250, 'F', '04,11', 11, 22, NULL),
(12, 'ปู๊ตี่บะหมี่เกี๊ยวกุ้ง', 0, 100, 'F', '01,11', 17, 23.59, NULL),
(13, 'ศรีไทยขาหมู', 0, 100, '?', '04,11', 9, 15, NULL),
(14, 'ครัวการ์ตูน', 0, 100, '?', '01,11', 9, 21, NULL),
(15, 'สุธารส', 0, 100, '?', '01,11', 7, 20, NULL),
(16, 'Buri Yummy', 0, 100, 'F', '01,02,04,11', 11, 22, NULL),
(17, 'D\'Eiffel', 251, 500, 'F', '04,11', 11, 22, NULL),
(18, 'ห้องนั่งเล่น', 0, 100, 'F', '01,11', 10, 20, NULL),
(19, 'โกวเล็ก กุ้งอบวุ้นเส้น', 101, 250, 'F', '01,03,11', 16, 22.3, NULL),
