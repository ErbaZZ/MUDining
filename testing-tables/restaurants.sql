...
(10, 'Kai Mara Noodle Tanantorn(ธนัญธรก๋วยเตี๋ยวไก่มะระ)', 0, 100, 'R', '01,11', 18.3, 1, NULL, "This the most interesting restaurant for Kai Mara Noodle love, but it opens quite late around 18.30 "),
...
(12, 'Pootee Shrimp wonton Noodle(ปู๊ตี่บะหมี่เกี๊ยวกุ้ง)', 0, 50, 'F', '03,11', 17, 23.59, NULL, "The old restaurant which located in front of Srifa bakery sell noodle there around 10 years. The highlight is large shrimp wonton."),
...
(14, 'Khrua Cartoon Resturant(ครัวการ์ตูน)', 0, 100, 'S', '01,11', 9, 21, NULL, ""),
...
(19, 'Guo Lek Shrimp vermicelli(โกวเล็ก กุ้งอบวุ้นเส้น)', 51, 250, 'F', '01,03,11', 16, 22.3, NULL, "It is street food that has long queue. You can enjoy with original taste of Hongkong Suki, Dried fish-maw soup and the other menus."),
(20, 'Rit Wanglang(Rit วังหลัง)', 101, 250, 'F', '02,11,12', 11, 21, NULL, "Sushi style Wanglang resturant with fair price suit for sushi lover.");
